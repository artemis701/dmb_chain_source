...
MY_VALIDATOR_ADDRESS=$(ponted keys show dev0 -a)
```
...
yes $KEYPASSWD | ponted keys add me
yes $KEYPASSWD | ponted keys show me
# start ponted with keyring-backend flag
ponted --keyring-backend=file start
```
