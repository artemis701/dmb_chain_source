...
ponted tx staking create-validator --from <VALIDATOR_KEY> --moniker thomas --pubkey $(ponted tendermint show-validator) --chain-id <MAINNODE_CHAIN_ID> --keyring-backend test --amount 1dmb --commission-max-change-rate 0.01 --commission-max-rate 0.2 --commission-rate 0.1 --min-self-delegation 1 --fees 20000admb -b block --gas auto