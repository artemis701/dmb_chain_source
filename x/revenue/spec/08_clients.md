...
Find below a list of  `ponted` commands added with the  `x/revenue` module. You can obtain the full list by using the `ponted -h` command. A CLI command can look like this:

```bash
ponted query revenue params
```
