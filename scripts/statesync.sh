...
# Initialize chain.
ponted init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.ponted/config/

wget -O ~/.ponted/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
...
export ponted_P2P_MAX_NUM_INBOUND_PEERS=200
export ponted_P2P_MAX_NUM_OUTBOUND_PEERS=200
export ponted_STATESYNC_RPC_SERVERS="https://evmos-rpc.polkachu.com:443,https://rpc-evmos-ia.notional.ventures:443"
